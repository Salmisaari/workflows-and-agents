...
_Placeholder — skill body to be written._

Back-references: `../../memory/principles.md` (memory IS the harness, types, compression strategies, search-augmented, providers).
